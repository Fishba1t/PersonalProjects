...
public class StartController {
        ...
        try
        {
            ...
            if(x>0){
                try {
                    ...
                    new_loader.setLocation(getClass().getResource("/com/example/socialnetworksystem/user.fxml"));
    ...
    public void signup() {
        try {
            // create a new stage for the popup dialog.
            FXMLLoader new_loader = new FXMLLoader();
            new_loader.setLocation(getClass().getResource("/com/example/socialnetworksystem/signup.fxml"));
    ...
    public void login() {
        try {
            // create a new stage for the popup dialog.
            FXMLLoader new_loader = new FXMLLoader();
            new_loader.setLocation(getClass().getResource("/com/example/socialnetworksystem/login.fxml"));
